...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss += bce_loss(logits_fake, 1 - true_labels)
...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    loss = torch.mean((scores_real - 1)**2)
    loss += torch.mean((scores_fake)**2)
    loss /= 2
...
def run_a_gan(D, G, D_solver, G_solver, discriminator_loss, 
              generator_loss, loader_train, show_every=250,
